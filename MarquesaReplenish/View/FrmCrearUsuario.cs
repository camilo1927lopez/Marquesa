...
namespace MarquesaReplenish.View
{
    public partial class FrmCrearUsuario : Form
    {
        ...
        UCUsuarioCrearEditar uCUsuarioCrearEditar = null;

        public FrmCrearUsuario(TblUsuarioModel tblUsuarioModel, TblRolModel tblRolModel)
        {
        ...
        public FrmCrearUsuario(TblUsuarioModel tblUsuarioModel, TblRolModel tblRolModel, TblUsuarioModel tblUsuarioPadreModel, TblRolModel tblRolPadreModel)
        {
            this._tblUsuarioModel = tblUsuarioModel;
            this._tblRolModel = tblRolModel;
