...
{
	public class TblEstadoModel 
	{
		public const string NOMBRE_TABLA = "tblEstado";
		...
		public void ParseData(DataRow dr)
		{
			...
			strNombreCampo = EnumCampos.Codigo.ToString();
			if (dr[strNombreCampo] != DBNull.Value)
			{
				this.Codigo = Convert.ToString(dr[strNombreCampo]);
			}
